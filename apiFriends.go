...
type APIFriends struct {
	API *API
}

// FriendsGetParams are params for APIFriends.Get
...
// FriendsGetResponse is response for APIFriends.Get
//easyjson:json
...
func (v APIFriends) Get(params FriendsGetParams) (*FriendsGetResponse, error) {
...
// FriendsGetOnlineParams are params for APIFriends.GetOnline
...
// FriendsGetOnlineResponse is response for APIFriends.GetOnline
// User ID
//easyjson:json
type FriendsGetOnlineResponse []int

// GetOnline Returns a list of user IDs of a user's friends who are online.
func (v APIFriends) GetOnline(params FriendsGetOnlineParams) (FriendsGetOnlineResponse, error) {
...
// FriendsGetMutualParams are params for APIFriends.GetMutual
...
// FriendsGetMutualResponse is response for APIFriends.GetMutual
// User ID
//easyjson:json
type FriendsGetMutualResponse []int

// GetMutual Returns a list of user IDs of the mutual friends of two users.
func (v APIFriends) GetMutual(params FriendsGetMutualParams) (FriendsGetMutualResponse, error) {
...
// FriendsGetRecentParams are params for APIFriends.GetRecent
type FriendsGetRecentParams struct {
	// Number of recently added friends to return.
	Count int `url:"count,omitempty"`
}

// FriendsGetRecentResponse is response for APIFriends.GetRecent
// User ID
//easyjson:json
type FriendsGetRecentResponse []int

// GetRecent Returns a list of user IDs of the current user's recently added friends.
func (v APIFriends) GetRecent(params FriendsGetRecentParams) (FriendsGetRecentResponse, error) {
...
// FriendsGetRequestsParams are params for APIFriends.GetRequests
...
// FriendsGetRequestsResponse is response for APIFriends.GetRequests
...
func (v APIFriends) GetRequests(params FriendsGetRequestsParams) (FriendsGetRequestsResponse, error) {
...
// FriendsAddParams are params for APIFriends.Add
...
// FriendsAddResponse is response for APIFriends.Add
// Friend request status
type FriendsAddResponse int

// Add Approves or creates a friend request.
func (v APIFriends) Add(params FriendsAddParams) (FriendsAddResponse, error) {
...
// FriendsEditParams are params for APIFriends.Edit
...
func (v APIFriends) Edit(params FriendsEditParams) (bool, error) {
...
// FriendsDeleteParams are params for APIFriends.Delete
...
// FriendsDeleteResponse is response for APIFriends.Delete
//easyjson:json
...
func (v APIFriends) Delete(params FriendsDeleteParams) (*FriendsDeleteResponse, error) {
...
// FriendsGetListsParams are params for APIFriends.GetLists
...
// FriendsGetListsResponse is response for APIFriends.GetLists
//easyjson:json
...
func (v APIFriends) GetLists(params FriendsGetListsParams) (*FriendsGetListsResponse, error) {
...
// FriendsAddListParams are params for APIFriends.AddList
...
// FriendsAddListResponse is response for APIFriends.AddList
//easyjson:json
...
func (v APIFriends) AddList(params FriendsAddListParams) (*FriendsAddListResponse, error) {
...
// FriendsEditListParams are params for APIFriends.EditList
...
func (v APIFriends) EditList(params FriendsEditListParams) (bool, error) {
...
// FriendsDeleteListParams are params for APIFriends.DeleteList
...
func (v APIFriends) DeleteList(params FriendsDeleteListParams) (bool, error) {
...
// FriendsGetAppUsersResponse is response for APIFriends.GetAppUsers
// User ID
//easyjson:json
...
func (v APIFriends) GetAppUsers() (FriendsGetAppUsersResponse, error) {
...
// FriendsGetByPhonesParams are params for APIFriends.GetByPhones
...
// FriendsGetByPhonesResponse is response for APIFriends.GetByPhones
//easyjson:json
type FriendsGetByPhonesResponse []User
...
func (v APIFriends) GetByPhones(params FriendsGetByPhonesParams) (FriendsGetByPhonesResponse, error) {
...
func (v APIFriends) DeleteAllRequests() (bool, error) {
...
// FriendsGetSuggestionsParams are params for APIFriends.GetSuggestions
...
// FriendsGetSuggestionsResponse is response for APIFriends.GetSuggestions
//easyjson:json
...
func (v APIFriends) GetSuggestions(params FriendsGetSuggestionsParams) (*FriendsGetSuggestionsResponse, error) {
...
// FriendsAreFriendsParams are params for APIFriends.AreFriends
...
// FriendsAreFriendsResponse is response for APIFriends.AreFriends
//easyjson:json
type FriendsAreFriendsResponse []struct {
	...
	ReadState BoolInt `json:"read_state,omitempty"`
...
func (v APIFriends) AreFriends(params FriendsAreFriendsParams) (FriendsAreFriendsResponse, error) {
...
// FriendsGetAvailableForCallParams are params for APIFriends.GetAvailableForCall
...
// FriendsGetAvailableForCallResponse is response for APIFriends.GetAvailableForCall
//easyjson:json
...
func (v APIFriends) GetAvailableForCall(params FriendsGetAvailableForCallParams) (*FriendsGetAvailableForCallResponse, error) {
...
// FriendsSearchParams are params for APIFriends.Search
...
// FriendsSearchResponse is response for APIFriends.Search
//easyjson:json
...
func (v APIFriends) Search(params FriendsSearchParams) (*FriendsSearchResponse, error) {
