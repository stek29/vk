...
type APILeads struct {
	API *API
}

// LeadsCompleteParams are params for APILeads.Complete
...
// LeadsCompleteResponse is response for APILeads.Complete
//easyjson:json
type LeadsCompleteResponse struct {
	...
	TestMode BoolInt `json:"test_mode,omitempty"`
	Success  BoolInt `json:"success,omitempty"`
}

// Complete Completes the lead started by user.
func (v APILeads) Complete(params LeadsCompleteParams) (*LeadsCompleteResponse, error) {
...
// LeadsStartParams are params for APILeads.Start
...
// LeadsStartResponse is response for APILeads.Start
//easyjson:json
...
func (v APILeads) Start(params LeadsStartParams) (*LeadsStartResponse, error) {
...
// LeadsGetStatsParams are params for APILeads.GetStats
...
// LeadsGetStatsResponse is response for APILeads.GetStats
//easyjson:json
...
func (v APILeads) GetStats(params LeadsGetStatsParams) (*LeadsGetStatsResponse, error) {
...
// LeadsGetUsersParams are params for APILeads.GetUsers
...
// LeadsGetUsersResponse is response for APILeads.GetUsers
//easyjson:json
...
func (v APILeads) GetUsers(params LeadsGetUsersParams) (LeadsGetUsersResponse, error) {
...
// LeadsCheckUserParams are params for APILeads.CheckUser
...
// LeadsCheckUserResponse is response for APILeads.CheckUser
//easyjson:json
...
func (v APILeads) CheckUser(params LeadsCheckUserParams) (*LeadsCheckUserResponse, error) {
...
// LeadsMetricHitParams are params for APILeads.MetricHit
type LeadsMetricHitParams struct {
	// Metric data obtained in the lead interface.
	Data string `url:"data"`
}

// LeadsMetricHitResponse is response for APILeads.MetricHit
//easyjson:json
...
func (v APILeads) MetricHit(params LeadsMetricHitParams) (*LeadsMetricHitResponse, error) {
