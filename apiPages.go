...
// PagesGetParams are params for APIPages.Get
...
// PagesGetResponse is response for APIPages.Get
//easyjson:json
type PagesGetResponse Page

// Get Returns information about a wiki page.
func (v APIPages) Get(params PagesGetParams) (*PagesGetResponse, error) {
...
// PagesSaveParams are params for APIPages.Save
...
// PagesSaveResponse is response for APIPages.Save
// Page ID
type PagesSaveResponse int

// Save Saves the text of a wiki page.
func (v APIPages) Save(params PagesSaveParams) (PagesSaveResponse, error) {
...
// PagesSaveAccessParams are params for APIPages.SaveAccess
...
// PagesSaveAccessResponse is response for APIPages.SaveAccess
// Page ID
type PagesSaveAccessResponse int

// SaveAccess Saves modified read and edit access settings for a wiki page.
func (v APIPages) SaveAccess(params PagesSaveAccessParams) (PagesSaveAccessResponse, error) {
...
// PagesGetHistoryParams are params for APIPages.GetHistory
...
// PagesGetHistoryResponse is response for APIPages.GetHistory
//easyjson:json
...
func (v APIPages) GetHistory(params PagesGetHistoryParams) (PagesGetHistoryResponse, error) {
...
// PagesGetTitlesParams are params for APIPages.GetTitles
type PagesGetTitlesParams struct {
	// ID of the community that owns the wiki page.
	GroupID int `url:"group_id,omitempty"`
}

// PagesGetTitlesResponse is response for APIPages.GetTitles
//easyjson:json
type PagesGetTitlesResponse []Page

// GetTitles Returns a list of wiki pages in a group.
func (v APIPages) GetTitles(params PagesGetTitlesParams) (PagesGetTitlesResponse, error) {
...
// PagesGetVersionParams are params for APIPages.GetVersion
...
// PagesGetVersionResponse is response for APIPages.GetVersion
//easyjson:json
type PagesGetVersionResponse Page

// GetVersion Returns the text of one of the previous versions of a wiki page.
func (v APIPages) GetVersion(params PagesGetVersionParams) (*PagesGetVersionResponse, error) {
...
// PagesParseWikiParams are params for APIPages.ParseWiki
...
// PagesParseWikiResponse is response for APIPages.ParseWiki
// HTML source
type PagesParseWikiResponse string

// ParseWiki Returns HTML representation of the wiki markup.
func (v APIPages) ParseWiki(params PagesParseWikiParams) (PagesParseWikiResponse, error) {
...
// PagesClearCacheParams are params for APIPages.ClearCache
...
func (v APIPages) ClearCache(params PagesClearCacheParams) (bool, error) {
