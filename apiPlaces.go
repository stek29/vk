...
type APIPlaces struct {
	API *API
}

// PlacesAddParams are params for APIPlaces.Add
...
// PlacesAddResponse is response for APIPlaces.Add
//easyjson:json
...
func (v APIPlaces) Add(params PlacesAddParams) (*PlacesAddResponse, error) {
...
// PlacesGetByIDParams are params for APIPlaces.GetByID
type PlacesGetByIDParams struct {
	// Location IDs.
	Places CSVIntSlice `url:"places"`
}

// PlacesGetByIDResponse is response for APIPlaces.GetByID
//easyjson:json
type PlacesGetByIDResponse []Place

// GetByID Returns information about locations by their IDs.
func (v APIPlaces) GetByID(params PlacesGetByIDParams) (PlacesGetByIDResponse, error) {
...
// PlacesSearchParams are params for APIPlaces.Search
...
// PlacesSearchResponse is response for APIPlaces.Search
//easyjson:json
...
func (v APIPlaces) Search(params PlacesSearchParams) (*PlacesSearchResponse, error) {
...
// PlacesCheckinParams are params for APIPlaces.Checkin
...
// PlacesCheckinResponse is response for APIPlaces.Checkin
//easyjson:json
...
func (v APIPlaces) Checkin(params PlacesCheckinParams) (*PlacesCheckinResponse, error) {
...
// PlacesGetCheckinsParams are params for APIPlaces.GetCheckins
...
// PlacesGetCheckinsResponse is response for APIPlaces.GetCheckins
//easyjson:json
...
func (v APIPlaces) GetCheckins(params PlacesGetCheckinsParams) (*PlacesGetCheckinsResponse, error) {
...
// PlacesGetTypesResponse is response for APIPlaces.GetTypes
//easyjson:json
...
func (v APIPlaces) GetTypes() (PlacesGetTypesResponse, error) {
