...
// VideoGetParams are params for APIVideo.Get
...
// VideoGetResponse is response for APIVideo.Get
...
// VideoEditParams are params for APIVideo.Edit
...
func (v APIVideo) Edit(params VideoEditParams) (bool, error) {
...
// VideoAddParams are params for APIVideo.Add
...
func (v APIVideo) Add(params VideoAddParams) (bool, error) {
...
// VideoSaveParams are params for APIVideo.Save
...
// VideoSaveResponse is response for APIVideo.Save
//easyjson:json
...
func (v APIVideo) Save(params VideoSaveParams) (*VideoSaveResponse, error) {
...
// VideoDeleteParams are params for APIVideo.Delete
...
func (v APIVideo) Delete(params VideoDeleteParams) (bool, error) {
...
// VideoRestoreParams are params for APIVideo.Restore
...
func (v APIVideo) Restore(params VideoRestoreParams) (bool, error) {
...
// VideoSearchParams are params for APIVideo.Search
...
// VideoSearchResponse is response for APIVideo.Search
...
func (v APIVideo) Search(params VideoSearchParams) (VideoSearchResponse, error) {
...
// VideoGetUserVideosParams are params for APIVideo.GetUserVideos
...
// VideoGetUserVideosResponse is response for APIVideo.GetUserVideos
...
func (v APIVideo) GetUserVideos(params VideoGetUserVideosParams) (VideoGetUserVideosResponse, error) {
...
// VideoGetAlbumsParams are params for APIVideo.GetAlbums
...
// VideoGetAlbumsResponse is response for APIVideo.GetAlbums
...
func (v APIVideo) GetAlbums(params VideoGetAlbumsParams) (VideoGetAlbumsResponse, error) {
...
// VideoGetAlbumByIDParams are params for APIVideo.GetAlbumByID
...
// VideoGetAlbumByIDResponse is response for APIVideo.GetAlbumByID
//easyjson:json
...
func (v APIVideo) GetAlbumByID(params VideoGetAlbumByIDParams) (*VideoGetAlbumByIDResponse, error) {
...
// VideoAddAlbumParams are params for APIVideo.AddAlbum
...
// VideoAddAlbumResponse is response for APIVideo.AddAlbum
//easyjson:json
...
func (v APIVideo) AddAlbum(params VideoAddAlbumParams) (*VideoAddAlbumResponse, error) {
...
// VideoEditAlbumParams are params for APIVideo.EditAlbum
...
func (v APIVideo) EditAlbum(params VideoEditAlbumParams) (bool, error) {
...
// VideoDeleteAlbumParams are params for APIVideo.DeleteAlbum
...
func (v APIVideo) DeleteAlbum(params VideoDeleteAlbumParams) (bool, error) {
...
// VideoReorderAlbumsParams are params for APIVideo.ReorderAlbums
...
func (v APIVideo) ReorderAlbums(params VideoReorderAlbumsParams) (bool, error) {
...
// VideoReorderVideosParams are params for APIVideo.ReorderVideos
...
func (v APIVideo) ReorderVideos(params VideoReorderVideosParams) (bool, error) {
...
// VideoAddToAlbumParams are params for APIVideo.AddToAlbum
...
func (v APIVideo) AddToAlbum(params VideoAddToAlbumParams) (bool, error) {
...
// VideoRemoveFromAlbumParams are params for APIVideo.RemoveFromAlbum
...
func (v APIVideo) RemoveFromAlbum(params VideoRemoveFromAlbumParams) (bool, error) {
...
// VideoGetAlbumsByVideoParams are params for APIVideo.GetAlbumsByVideo
...
// VideoGetAlbumsByVideoResponse is response for APIVideo.GetAlbumsByVideo
...
func (v APIVideo) GetAlbumsByVideo(params VideoGetAlbumsByVideoParams) (VideoGetAlbumsByVideoResponse, error) {
...
// VideoGetCommentsParams are params for APIVideo.GetComments
...
// VideoGetCommentsResponse is response for APIVideo.GetComments
...
func (v APIVideo) GetComments(params VideoGetCommentsParams) (VideoGetCommentsResponse, error) {
...
// VideoCreateCommentParams are params for APIVideo.CreateComment
...
// VideoCreateCommentResponse is response for APIVideo.CreateComment
// Created comment ID
type VideoCreateCommentResponse int

// CreateComment Adds a new comment on a video.
func (v APIVideo) CreateComment(params VideoCreateCommentParams) (VideoCreateCommentResponse, error) {
...
// VideoDeleteCommentParams are params for APIVideo.DeleteComment
...
func (v APIVideo) DeleteComment(params VideoDeleteCommentParams) (bool, error) {
...
// VideoRestoreCommentParams are params for APIVideo.RestoreComment
...
func (v APIVideo) RestoreComment(params VideoRestoreCommentParams) (bool, error) {
...
// VideoEditCommentParams are params for APIVideo.EditComment
...
func (v APIVideo) EditComment(params VideoEditCommentParams) (bool, error) {
...
// VideoGetTagsParams are params for APIVideo.GetTags
...
// VideoGetTagsResponse is response for APIVideo.GetTags
//easyjson:json
type VideoGetTagsResponse []genTODOType /* objects.json#/definitions/video_video_tag */
// GetTags Returns a list of tags on a video.
func (v APIVideo) GetTags(params VideoGetTagsParams) (VideoGetTagsResponse, error) {
...
// VideoPutTagParams are params for APIVideo.PutTag
...
// VideoPutTagResponse is response for APIVideo.PutTag
// Created tag ID
type VideoPutTagResponse int

// PutTag Adds a tag on a video.
func (v APIVideo) PutTag(params VideoPutTagParams) (VideoPutTagResponse, error) {
...
// VideoRemoveTagParams are params for APIVideo.RemoveTag
...
func (v APIVideo) RemoveTag(params VideoRemoveTagParams) (bool, error) {
...
// VideoGetNewTagsParams are params for APIVideo.GetNewTags
...
// VideoGetNewTagsResponse is response for APIVideo.GetNewTags
//easyjson:json
...
func (v APIVideo) GetNewTags(params VideoGetNewTagsParams) (*VideoGetNewTagsResponse, error) {
...
// VideoReportParams are params for APIVideo.Report
...
func (v APIVideo) Report(params VideoReportParams) (bool, error) {
...
// VideoReportCommentParams are params for APIVideo.ReportComment
...
func (v APIVideo) ReportComment(params VideoReportCommentParams) (bool, error) {
...
// VideoGetCatalogParams are params for APIVideo.GetCatalog
...
// VideoGetCatalogResponse is response for APIVideo.GetCatalog
...
func (v APIVideo) GetCatalog(params VideoGetCatalogParams) (VideoGetCatalogResponse, error) {
...
// VideoGetCatalogSectionParams are params for APIVideo.GetCatalogSection
...
// VideoGetCatalogSectionResponse is response for APIVideo.GetCatalogSection
...
func (v APIVideo) GetCatalogSection(params VideoGetCatalogSectionParams) (VideoGetCatalogSectionResponse, error) {
...
// VideoHideCatalogSectionParams are params for APIVideo.HideCatalogSection
...
func (v APIVideo) HideCatalogSection(params VideoHideCatalogSectionParams) (bool, error) {
