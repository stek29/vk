...
// AuthSignupParams are params for Auth.Signup
...
// AuthSignupResponse is response for Auth.Signup
//easyjson:json
...
func (v Auth) Signup(params AuthSignupParams) (*AuthSignupResponse, error) {
...
// AuthConfirmParams are params for Auth.Confirm
...
// AuthConfirmResponse is response for Auth.Confirm
//easyjson:json
...
func (v Auth) Confirm(params AuthConfirmParams) (*AuthConfirmResponse, error) {
