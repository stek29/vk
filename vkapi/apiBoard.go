...
// BoardGetTopicsResponse is response for Board.GetTopics
...
type BoardGetTopicsResponseNormal struct {
	...
	Items []vk.BoardTopic `json:"items,omitempty"`
	// Sort type
	DefaultOrder int `json:"default_order,omitempty"`
	// Information whether current user can add topic
	CanAddTopics vk.BoolInt `json:"can_add_topics,omitempty"`
}
...
// BoardGetCommentsResponse is response for Board.GetComments
...
type BoardGetCommentsResponseNormal struct {
	// Total number
	Count int               `json:"count,omitempty"`
	Items []vk.CommentBoard `json:"items,omitempty"`
	Poll  vk.Poll           `json:"poll,omitempty"`
}
...
// BoardAddTopicResponse is response for Board.AddTopic
// Topic ID
...
// BoardCreateCommentResponse is response for Board.CreateComment
// Comment ID
