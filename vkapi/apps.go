...
// AppsSendRequestResponse is response for Apps.SendRequest
// Request ID
...
// AppsGetLeaderboardResponse is response for Apps.GetLeaderboard
...
// AppsGetScoreResponse is response for Apps.GetScore
// Score number
