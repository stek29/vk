...
// NewsfeedGetBannedResponse is response for Newsfeed.GetBanned
...
type NewsfeedGetBannedResponseExtended struct {
	Groups  []vk.User  `json:"groups,omitempty"`
	Members []vk.Group `json:"members,omitempty"`
}
...
// NewsfeedSearchResponse is response for Newsfeed.Search
...
// NewsfeedGetListsResponse is response for Newsfeed.GetLists
...
// NewsfeedSaveListResponse is response for Newsfeed.SaveList
// List ID
