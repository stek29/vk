...
// PhotosGetResponse is response for Photos.Get
...
// PhotosGetAlbumsCountResponse is response for Photos.GetAlbumsCount
// Albums number
...
// PhotosGetByIDResponse is response for Photos.GetByID
...
//easyjson:json
type PhotosGetByIDResponseNormal []vk.Photo
...
//easyjson:json
type PhotosGetByIDResponseExtended []vk.Photo
...
//easyjson:json
type PhotosSaveMarketPhotoResponse []vk.Photo
...
//easyjson:json
type PhotosSaveOwnerCoverPhotoResponse []vk.BaseImage
...
//easyjson:json
type PhotosSaveMarketAlbumPhotoResponse []vk.Photo
...
//easyjson:json
type PhotosSaveWallPhotoResponse []vk.Photo
...
//easyjson:json
type PhotosSaveMessagesPhotoResponse []vk.Photo
...
//easyjson:json
type PhotosSaveResponse []vk.Photo
...
// PhotosCopyResponse is response for Photos.Copy
// Photo ID
...
// PhotosGetAllResponse is response for Photos.GetAll
...
// PhotosGetCommentsResponse is response for Photos.GetComments
...
// PhotosCreateCommentResponse is response for Photos.CreateComment
// Created comment ID
...
// PhotosPutTagResponse is response for Photos.PutTag
// Created tag ID
